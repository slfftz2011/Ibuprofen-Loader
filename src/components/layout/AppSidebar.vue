...
const navItems: NavItem[] = [
  ...
  { name: "components", path: "/components", icon: "package", label: "组件管理", group: "main" },
  { name: "inject", path: "/inject", icon: "zap", label: "注入", group: "main" },
  ...
  <aside class="sidebar glass-strong" :class="{ collapsed: ui.sidebarCollapsed }">
    <div class="sidebar-logo" @click="navigateTo('/')">
      ...
      <transition name="fade">
        <span v-if="!ui.sidebarCollapsed" class="logo-text">Ibuprofen Loader</span>
      </transition>
    </div>
